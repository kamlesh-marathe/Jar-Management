...
//                Toast.makeText(view.getContext(), ""+routesel, Toast.LENGTH_SHORT).show();
//                Toast.makeText(getContext(), "Val is "+editText3.getText().toString(), Toast.LENGTH_SHORT).show();
                ...
                {
                    dbHandler.addcustomer(0,editText9.getText().toString(),editText3.getText().toString(),editText4.getText().toString(),editText5.getText().toString(),editText6.getText().toString(),routesel,flit,jarpr,false);
        ...
        spinner = (Spinner) view.findViewById(R.id.spinner);
//        String[] items = new String[]{"Route 1", "Route 2", "Route 3"};
//        Toast.makeText(getContext(), "Checking Route", Toast.LENGTH_SHORT).show();
//        Toast.makeText(getContext(), "Route Taken", Toast.LENGTH_SHORT).show();
        ...
        editText1= (EditText) view.findViewById(R.id.editText8);
        editText1.setEnabled(false);
        editText2= (EditText) view.findViewById(R.id.editText9);
